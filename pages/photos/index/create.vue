<template>
  <section class="modal overlayed faded">
    <nuxt-link to="/photos" class="modal__close-link"><font-awesome icon="times" /></nuxt-link>
    <div class="modal__container">
      <h2>Creando una foto</h2>
      <my-form :onSubmit="createPhoto" :errors="errors" text="Crear la foto">
